...
def test_get_multiple_mlb_player_stats():
    mcp = MagicMock()
    mlb_api.setup_mlb_tools(mcp)
...
def test_get_mlb_game_highlights():
    mcp = MagicMock()
    mlb_api.setup_mlb_tools(mcp)
...
def test_get_mlb_game_scoring_plays():
    mcp = MagicMock()
    mlb_api.setup_mlb_tools(mcp)
...
def test_get_mlb_search_players():
    mcp = MagicMock()
    mlb_api.setup_mlb_tools(mcp)
